      ...
      <div className="min-h-screen bg-gray-50/50 pb-12">
        ...
        <header className="bg-white border-b border-gray-100 sticky top-0 z-30">
          <div className="max-w-4xl mx-auto px-4 h-16 flex items-center">
            <Link href="/dashboard/recipient" className="text-gray-500 hover:text-[#4CAF50] transition-colors flex items-center">
              ...
              {item.images?.length > 1 && (
                <div className="grid grid-cols-4 gap-2">
                  {item.images.slice(1).map((img: string, i: number) => (
                    <div key={i} className="aspect-square bg-white rounded-lg overflow-hidden relative border border-gray-100 shadow-sm">
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center space-x-2 mb-2">
                  ...
                  <span className="px-2 py-1 bg-[#4CAF50]/10 text-[#2E7D32] rounded-md text-xs font-medium">
              ...
              {/* Donor Info */}
              <div className="bg-white rounded-xl p-4 border border-gray-100 flex items-center space-x-4 shadow-sm">
                ...
                <div>
                  ...
                  <div className="flex items-center text-sm text-gray-500 mt-1">
                    <ShieldCheck className="w-4 h-4 mr-1 text-[#4CAF50]" />
              ...
              <Card className="border-0 shadow-sm overflow-hidden bg-white">
                <CardContent className="p-6">
                  ...
                  {requestSuccess ? (
                    <div className="bg-[#4CAF50]/10 border border-[#4CAF50]/20 rounded-lg p-4 text-center">
                      <Heart className="w-8 h-8 text-[#4CAF50] mx-auto mb-2" />
