            ...
            <Card className="border-0 shadow-sm bg-white">
              <CardContent className="p-14 text-center">
                ...
                <Link href="/dashboard/recipient">
                  <Button className="bg-[#4CAF50] hover:bg-[#45a049] text-white">Browse Items</Button>
                </Link>
              </CardContent>
            </Card>
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-1.5">
                        <div className="w-6 h-6 rounded-full bg-gray-200 overflow-hidden">
                          {item.donor?.avatarUrl ? (
                            ...
                            <div className="w-full h-full bg-[#4CAF50]/30 flex items-center justify-center text-[10px] font-bold text-[#2E7D32]">
                      ...
                      {item.status === 'available' && (
                        <Link href={`/dashboard/recipient/item/${item._id}`}>
                          <Button size="sm" className="text-xs bg-[#4CAF50] hover:bg-[#45a049] text-white">
                            Request
                          </Button>
                        </Link>
                      )}
