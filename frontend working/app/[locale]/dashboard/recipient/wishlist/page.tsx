        ...
        <main className="max-w-3xl mx-auto px-4 pt-8 space-y-6">
          ...
          <div className="bg-[#4CAF50]/10 border border-[#4CAF50]/20 rounded-xl p-4">
            <div className="flex items-start space-x-3">
              <Heart className="w-5 h-5 text-[#4CAF50] mt-0.5 flex-shrink-0" />
          ...
          {/* Add Form */}
          {showForm && (
            <Card className="border-0 shadow-sm bg-white border-t-4 border-t-[#4CAF50]">
                  ...
                  <CardContent className="p-5 flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${entry.alertEnabled ? 'text-[#4CAF50] bg-[#4CAF50]/10' : 'text-gray-400 hover:bg-gray-100'}`}
